    ...
    <div className="w-full h-full flex flex-col justify-center items-center gap-8">
      ...
      <div className="grid grid-cols-1 landscape:grid-cols-2 w-full landscape:w-fit gap-4">
        ...
        >
          ...
          <p className="break-keep">위 사이트의 학습을 돕기 위해 만들어졌습니다</p>
        </Link>
        <div className="border-2 border-black dark:border-white w-full p-4 landscape:w-72 rounded-md">
          <h2>학습 구성</h2>
          <p className="break-keep">각 페이지는 Open AI 실습 툴과 번역본으로 구성되어 있습니다</p>
        </div>
      </div>
      <h1>준비해주세요</h1>
      <div className="grid grid-cols-1 landscape:grid-cols-2 w-full landscape:w-fit gap-4">
        ...
        >
          ...
          <h2>Open AI 가입</h2>
          <p className="break-keep">홈페이지에 접속하셔서 계정을 생성해주세요</p>
        </Link>
        <Link
        ...
        >
          ...
          <h2>API Key 발급</h2>
          <p className="break-keep">API 페이지에 접속하셔서 API Key를 발급해주세요</p>
        </Link>
      </div>
      <h1>유의해주세요</h1>
      <div className="grid grid-cols-1 landscape:grid-cols-2 w-full landscape:w-fit gap-4">
        <div className="border-2 border-black dark:border-white w-full p-4 landscape:w-72 rounded-md">
          <h2>개인정보보호</h2>
          <p className="break-keep">Api Key와 같은 개인정보는 일절 수집하지 않습니다.</p>
        </div>
        <div className="border-2 border-black dark:border-white w-full p-4 landscape:w-72 rounded-md">
          <h2>ChatCompletion</h2>
          <p className="break-keep">Open AI 실습 툴은 Chat 기반으로 만들어졌습니다</p>
        </div>
      </div>
    </div>
  )
